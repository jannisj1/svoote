...
pub async fn get_landing_page(
    ...
    return Ok(html_page::render_html_page( "Svoote", html! {
        ...
        #features ."my-64" {
            ."container mx-auto px-4" {
                ."ml-4 mb-2 text-xl text-slate-600 font-medium" { "Features" }
            }
            ."bg-slate-100 px-4 py-8 md:px-8 lg:rounded-lg lg:container lg:mx-auto" {
                ."mt-6 mb-12 text-slate-800 text-3xl font-medium text-center leading-10" {
                    "Get feedback from your audience in real time."
                }
        ...
        #pricing ."mb-64" {
            ."container mx-auto px-4" {
                ."ml-4 mb-2 text-xl text-slate-600 font-medium" { "Plans and Pricing" }
            }

            ."bg-slate-100 px-4 py-8 md:px-8 lg:rounded-lg lg:container lg:mx-auto" {
                ."mt-6 mb-12 text-slate-800 text-3xl font-medium text-center leading-10" {
                    "Get started for free. Upgrade if you need to."
                }
        ...
        #mission ."mb-64" {
            ."container mx-auto px-4" {
                ."ml-4 mb-2 text-xl text-slate-600 font-medium" { "Mission" }
            }

            ."bg-slate-100 p-6 lg:rounded-lg lg:container lg:mx-auto" {
                ."mt-6 mb-12 text-slate-800 text-3xl font-medium text-center leading-10" {
                    "Simple. Privacy-friendly. Open source."
                }
...
fn render_plan(
    ...
    return html! {
        ."max-w-64 p-8 bg-white rounded-lg" {
