        ...
        html! {
            ...
            div x-data="poll" ."flex-1 flex flex-col" {
                ...
                div id="fullscreen-container"
                    ...
                    ":class"="'min-w-[520px] px-6 sm:px-14 ' + (isFullscreen ? 'bg-slate-700 h-full flex flex-col justify-center' : 'bg-slate-100 flex-1')"
                    x-data="{ slide: null }"
                    ...
                    x-effect="slide = poll.slides[poll.activeSlide]"
                {
                    ...
                    div ."flex gap-4" {
                        div ."flex-1 h-[38rem] px-[1.5em] sm:px-[3.5em] pb-[2.5em] pt-[3.5em] flex gap-[3.5em] bg-white border rounded-lg"
                        ...
                        div ."w-72 pr-4.5 pl-2.5 pt-1.5 bg-white border rounded-lg"
                        {
